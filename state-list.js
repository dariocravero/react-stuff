...
export default class AppStateList extends Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      ...
      list: [{
        ...
        content: `Sola agreed with me, and it was decided that we should leave Thark this same night; just as quickly, in fact, as I could find and saddle my thoats.  Sola was to ride one and Dejah Thoris and I the other; each of us carrying sufficient food and drink to last us for two days, since the animals could not be urged too rapidly for so long a distance.`,
  ...
  render() {
    return (
      <div>
        ...
        <p>{this.state.list[this.state.active].content}</p>
      </div>
    )
  }
}
